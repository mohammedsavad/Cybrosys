...
$("form").submit(function(e) {
  ...
  $('body').on('click','.btn-edit',function() {
    ...
    $(this).parents('tr').find('td:eq(0)').html("<input name='edit_text' class='form-control' value='"+name+"'>");
  ...
  $('body').on('click','.btn-update',function() {
    ...
    $('#'+id).parents('tr').find('td:eq(0)').text(name);
    $('#'+id).parents('tr').attr('data-name',name);
